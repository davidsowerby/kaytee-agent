 ...
 */
class DefaultManualTaskRunner @Inject constructor(globalBusProvider: GlobalBusProvider, val manualTaskLauncher: ManualTaskLauncher, @Assisted build: Build, @Assisted taskKey: TaskKey) :
