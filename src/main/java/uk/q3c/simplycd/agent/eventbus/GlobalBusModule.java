...
public class GlobalBusModule extends AbstractModule {
    ...
    protected void bindConfigurationErrorHandlers() {
        bind(ConfigurationErrorHandler.class).annotatedWith(uk.q3c.simplycd.agent.eventbus.GlobalBus.class)
    ...
    protected void bindPublicationErrorHandlers() {
        bind((IPublicationErrorHandler.class)).annotatedWith(uk.q3c.simplycd.agent.eventbus.GlobalBus.class)
